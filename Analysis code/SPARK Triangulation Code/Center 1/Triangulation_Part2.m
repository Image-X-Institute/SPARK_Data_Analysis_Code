...
% FOLDER_NAME = 'MV150kV150'
% outputPath = strcat('C:\KIM\test_KIM\',FOLDER_NAME,'\','Results')
% fxPath =strcat('C:\KIM\test_KIM\',FOLDER_NAME);
...
% 05/10/2016 
%MVOffsetsX = [-1.84285 2.39565 -17.2589]; %Org CCW Xp
%MVOffsetsY = [8.528113 0.741552 87.09469]; %Org CCW Yp
%MVOffsetsX = [-1.78951	2.43598	-22.0157]; %Org CW Xp
%MVOffsetsY = [8.523888	0.777959	89.54838]; %Org CW Yp

%%%MVOffsetsX = [-1.84285 2.39565 -0.2589]; %modified CCW Xp
%%%MVOffsetsY = [15.528113 0.741552 87.09469]; %modified CCW Yp

% Isocenter offsets
% MV Isocal/TS3/29 Oct 2014
%MVOffsetsX = [-1.57 4.4 0.568];
%MVOffsetsY = [7.079 0.9248 65.14]; %modified to match SI
%MVOffsetsY = [2.579 0.9248 65.14];
...
% [header, Data] = readMVMarkerPositions([outputPath '\' pat fx 'MVMarkerPositions.xls'])
% [outputPath '\' pat fx 'MVMarkerPositions.xls']

%[header, Data] = readMVMarkerPositions([outputPath '\' 'AutoMVMarkerPositions.xls']); 
%[header, Data] = readMVMarkerPositions([outputPath '\' 'MVMarkerPositions.xls']); 

[header, Data] = combine_Auto_Man_Segmentation(outputPath);

%[outputPath '\' 'MVMarkerPositions.xls']
...
syncErr = 0;
    ...
    Data.VecDiff3(n) = sqrt(    (Data.TriX3(n) - Data.x3(n+syncErr)).^2 + (Data.TriY3(n) - Data.y3(n+syncErr)).^2 + (Data.TriZ3(n) - Data.z3(n+syncErr)).^2     );
...
if isempty(DataMarker1.kVWindowsTimestamps)
  ...
  %  plot(DataMarker1.MVGantryAngle, DataMarker1.TriX1, 'kv', DataMarker1.MVGantryAngle, DataMarker1.TriY1, 'kv', DataMarker1.MVGantryAngle, DataMarker1.TriZ1, 'kv', 'linewidth', 2)
  %  plot(DataMarker1.MVGantryAngle, DataMarker1.x1, 'b+', DataMarker1.MVGantryAngle, DataMarker1.y1, 'g+', DataMarker1.MVGantryAngle, DataMarker1.z1, 'r+', 'linewidth', 6)
    hold off
...
%[DataMarker1.x1  DataMarker1.y1  DataMarker1.z1 DataMarker1.TriX1' DataMarker1.TriY1' DataMarker1.TriZ1' DataMarker1.VecDiff1']
...
if isempty(DataMarker2.kVWindowsTimestamps)
  ...
  %  plot(DataMarker2.MVGantryAngle, DataMarker2.TriX2, 'kv', DataMarker2.MVGantryAngle, DataMarker2.TriY2, 'kv', DataMarker2.MVGantryAngle, DataMarker2.TriZ2, 'kv', 'linewidth', 2)
  %  plot(DataMarker2.MVGantryAngle, DataMarker2.x2, 'b+', DataMarker2.MVGantryAngle, DataMarker2.y2, 'g+', DataMarker2.MVGantryAngle, DataMarker2.z2, 'r+', 'linewidth', 6)
...
%[DataMarker2.x2  DataMarker2.y2  DataMarker2.z2 DataMarker2.TriX2' DataMarker2.TriY2' DataMarker2.TriZ2' DataMarker2.VecDiff2']
...
if isempty(DataMarker3.kVWindowsTimestamps)
  ...
  %  plot(DataMarker3.MVGantryAngle, DataMarker3.x3, 'b+', DataMarker3.MVGantryAngle, DataMarker3.y3, 'g+', DataMarker3.MVGantryAngle, DataMarker3.z3, 'r+', 'linewidth', 6)    
    hold off
  %  xlabel('Time (s)', 'fontsize', 16)autom
  %  xlabel('MV Gantry Angle (^\circ)', 'fontsize', 16)
    xlabel('kV Frame No','fontsize',16)
    ylabel('Position (mm)', 'fontsize', 16')
...
%[DataMarker3.x3  DataMarker3.y3  DataMarker3.z3 DataMarker3.TriX3' DataMarker3.TriY3' DataMarker3.TriZ3' DataMarker3.VecDiff3']
...
MVPixelSizeAtIso = 0.336; % in mm
kVPixelSizeAtIso = 0.388; % in mm

% Do the appropriate transformations for xp and yp
xp1 = (xp1 - 512)*MVPixelSizeAtIso/MVSDD;
yp1 = -(yp1 - 387)*MVPixelSizeAtIso/MVSDD;

xp2 = (xp2 - 512)*kVPixelSizeAtIso/kVSDD;
yp2 = -(yp2 - 387)*kVPixelSizeAtIso/kVSDD;


%(mv_angle,(mv_x_calib-512)*mv_pixel/mv_vrt,(384-mv_y_calib)*mv_pixel/mv_vrt,kv_angle,(kv_x_calib1-512)*kv_pixel/kv_vrt,(384-kv_y_calib1)*kv_pixel/kv_vrt);
