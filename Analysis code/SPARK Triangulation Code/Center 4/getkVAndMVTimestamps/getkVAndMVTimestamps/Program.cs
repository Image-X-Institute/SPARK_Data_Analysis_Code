...
namespace getkVAndMVTimestamps
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string kVFolder = parentPath + "\\KV";
            string MVFolder = parentPath + "\\MV";

            // Grab string of filenames
            string[] listOfkVImages = Directory.GetFiles(kVFolder, "*.hnd");
            string[] listOfMVImages = Directory.GetFiles(MVFolder, "*.hnd");
